...
| 9 | Gemini embedContent 基础转换和 usage 扣费 | 已覆盖：`TestGeminiEmbedContentConvertsOpenAIEmbeddingsAndDeductsUsage` | 证明 Gemini 单条 Embedding 入口不是只注册路径，能转 OpenAI-compatible Embeddings 上游并返回 Gemini 外形。 |
