...
| G16 访问控制 | API Key scope、用户分组、通道分组和模型/APIType 权限只能收窄，不能放大权限。 | `TestAPIKeyModelScopeRestrictsRelayBeforeUpstream`、`TestAPIKeyAPIScopeRestrictsRelayBeforeUpstream`、访问允许/拒绝测试。 |
