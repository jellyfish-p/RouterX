...
|-----------|----------------|------------------|------------|
| 400 | `invalid_json`、`invalid_multipart`、`multipart_file_required`、`unsafe_multipart_file`、`model_required`、`invalid_routerx_options`、`routerx_hop_exceeded` | `invalid_request_error` / `INVALID_ARGUMENT` | 修正请求参数 |
