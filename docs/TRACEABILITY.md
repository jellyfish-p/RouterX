...
| P0-C2 | 默认 settings 写入 | 空库实例有可预测默认配置。 | `SETTINGS`、`OPERATIONS`、`DATA_MODEL` | `SettingService`、`SetupService.buildDefaultSettings`、Redis settings cache | `TestSetupBootstrapAdminQuotaAndSettingsDefaults`、`TestSettingsValidationAndReadiness` |
