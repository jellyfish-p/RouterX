...
| P2-C2 | 管理审计 | 关键管理行为可追溯。 | `OBSERVABILITY`、`OPERATIONS`、`DATA_MODEL`、`ACCOUNTS` | audit logs、admin service hooks | 支付商品管理、settings 更新、用户调额、充值码管理审计和超级管理员查询边界已覆盖；通道、账号、失败和拒绝操作审计测试仍需补齐 |
