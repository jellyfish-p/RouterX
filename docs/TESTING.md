...
| `TestRelayMultipartRejectsUnsafeFileNameBeforeUpstream` | OpenAI-compatible multipart 文件名命中危险扩展名基础扫描时本地返回 400 `unsafe_multipart_file`，不调用上游、不扣用户额度或 API Key 预算 |
