...
| `TestApifoxOpenAPICoversRegisteredRoutes` | 从 Gin 注册路由读取实际 `METHOD path`，解析 `docs/apifox/openapi.yaml` 的 OpenAPI paths，确保已注册公开 API 都有 Apifox 可导入的文档条目；Gemini action wildcard 会展开为真实公开 action URL |
