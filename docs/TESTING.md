...
| P1 | 调用事实快照 | 调用日志已覆盖 request_id、error_code、error_source、upstream_status、基础 usage_source、基础 route_snapshot 和含预算前后摘要的基础 billing_snapshot；继续补 request、policy、完整 route、usage、完整 billing、error 快照脱敏和历史解释 |
