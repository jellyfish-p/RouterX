...
| P2 | 企业账号 | 本地密码成功登录审计、OAuth state、已绑定 subject 登录、登录用户 subject 绑定、禁止 email 自动接管、身份列表、非主 OAuth identity 解绑、OIDC Discovery、nonce、ID Token 签名校验和登录用户 OIDC subject 绑定已覆盖；OAuth/OIDC 首次补齐注册和注销账号恢复待补 |
