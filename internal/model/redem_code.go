...
type RedemCode struct {
	...
	Status    int        `gorm:"not null;default:0" json:"status"`                  // 0=未使用, 1=已使用, 2=已作废
	BatchNo   string     `gorm:"type:varchar(64);not null;default:'';index" json:"batch_no,omitempty"`
	Note      string     `gorm:"type:varchar(256);not null;default:''" json:"note,omitempty"`
